...
public class Course {
	...
	private int availableSeats;
        ...
        private Map<Integer, Integer> placesInstructor;
	private int year;
	...
	public void allocateSeats(int instuctorId, int capacity){
            ...
            { 
                ...
                {
                    int balanceAviabable=balance-this.availableSeats;
                    //if(balance- this.availableSeats)
                }
            }
        }
	/*public void allocateSeatsXXX(Instructor Instructor, int Capacity){
		String output="";
